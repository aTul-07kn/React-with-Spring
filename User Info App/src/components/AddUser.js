    ...
    <div className='h-screen flex justify-center items-center'>
      <form className="m-5 bg-gray-800 p-6 rounded-2xl"  onSubmit={handleSubmit}>
        <div className="mb-5">
          ...
          <button type="submit" className="text-white  focus:ring-4 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center bg-blue-600 hover:bg-blue-700 focus:ring-blue-800">Add User</button>
      </form>
    </div>
  )
}
